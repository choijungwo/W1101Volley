package kr.ac.kumoh.s20181210.w1101volley
...
import kr.ac.kumoh.s20181210.w1101volley.databinding.ActivityMainBinding
...
//                        Toast.LENGTH_LONG).show()
                    binding.listMovies.adapter = ArrayAdapter<String>(this, R.layout.simple_list_item_1, movies)
                },
                {
                    Toast.makeText(application, it.toString(), Toast.LENGTH_LONG).show()
                }
